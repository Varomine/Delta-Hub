...
_G.FARM = false
if _G.Build_a_boat["Auto Gold"] == true then
	_G.FARM = true 
else
	_G.FARM = false
end
_G.TOOL = false 
if _G.Build_a_boat["Auto Tool"] == true then 
	_G.TOOL = true 
else
	_G.TOOL = false
end
if _G.Build_a_boat["FPS Boost"] == true then
	loadstring(game:HttpGet("https://pastebin.com/raw/VSjtWEDe"))()
end


local Window = create:Win(os.date("Delta Hub [ Build A Boat For Treasure - V1 ]"))
local main = Window:Taps("Main")
local farmtab = main:newpage()
local farmtab2 = main:newpage()
...
function ToxmodsisHOT()
    ...
    if _G.Auto_Farm then
        ...
        tween =
            ...
            game:GetService("Players")["LocalPlayer"].Character:WaitForChild("HumanoidRootPart"),
            tweenInfo,
            {CFrame = CFrame.new(-56.2553825, -359.252441, 9496.5293, -0.997279763, 0, 0.0737069249, 0, 1, 0, -0.0737069249, 0, -0.997279763)}
        )
        tween:Play()
...
farmtab:Toggle("Auto Farm",_G.FARM,function(State)
    _G.Auto_Farm = State
...
local Chest = {"Common Chest","Uncommon Chest","Rare Chest","Epic Chest","Legendary Chest"}

local field = farmtab:Drop("Select Chest",false,Chest,function(Option)
    _G.Chest = Option
end)

farmtab:Toggle("Auto Chest",false,function(State)
    _G.Auto_Chest = State
end)

farmtab:Toggle("ANTI-AFK",true,function(State)
    _G.AFK = State
end)

farmtab2:Label("Teleport")

farmtab2:Button("Blue Zone",function()
...
farmtab2:Button("Green Zone",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").CamoZone.CFrame * CFrame.new(0,5,0)
end)

farmtab2:Button("White Zone",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").WhiteZone.CFrame * CFrame.new(0,5,0)
end)

farmtab2:Button("Red Zone",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(263.18158, -9.85240746, -66.8505325, -0.0493402816, -9.84514017e-08, 0.998782039, -2.5194927e-08, 1, 9.73268186e-08, -0.998782039, -2.03621084e-08, -0.0493402816)
end)
